---
name: human-writing
description: Draft and revise prose so it sounds natural, specific, purposeful, and appropriate to its author and audience. Use when asked to humanize or de-AI text, match an existing voice, remove formulaic AI-style writing, or produce natural articles, reports, emails, documentation, posts, and other prose. Do not use to game AI detectors, conceal authorship, impersonate a real person, or fabricate human experiences.
---
...
Write for a real reader with a real reason to read.

Before drafting, determine:

- The audience and purpose
- The genre and medium
- The desired tone and level of formality
- The appropriate English variety and house style
- The writer's relationship to the reader
- The facts, quotations, and wording that must remain unchanged
- The expected length and depth

Infer reasonable defaults from the request. Ask a question only when an unresolved choice would materially change the result.

Follow explicit instructions and genre conventions over general preferences in this skill.

## Preserve the writer's voice

Treat supplied writing samples as the primary style reference.

Match observable features such as directness, vocabulary, contractions, sentence length, humor, punctuation, paragraphing, spelling, and degree of certainty.

Preserve distinctive wording that works. Do not polish every sentence into the same neutral professional voice.
...
6. **Remove formulaic patterns.** Use the diagnostic table below.
...
Use concrete nouns and accurate verbs. Prefer information that distinguishes the subject from similar subjects.

Use simple constructions freely:
...
Do not replace them automatically with `serves as`, `stands as`, `boasts`, `features`, `authored`, `utilized`, `attempted`, `relocated`, or other elevated alternatives.

Use technical or formal vocabulary when it improves precision. Do not simplify away necessary distinctions.

Keep necessary context and explanation. Concision is not the same as choppiness.

## Diagnose patterns in context

Treat the following as patterns to inspect, not forbidden constructions. One transition, formal word, or group of three does not make writing artificial. Look for clusters, repetition, and unsupported rhetoric.

| Pattern | Diagnose | Repair |
|---|---|---|
| Generic opening | The text begins with ceremony instead of useful information: “Certainly,” “Great question,” or “In today's rapidly evolving world.” | Start with the answer, event, claim, or request. |
...
| Overformal contrast | Routine prose repeatedly begins sentences with “However,” when a simple conjunction would sound more natural. | Prefer but, yet, though, still, or combine the clauses. Keep however when the register is formal and the contrast warrants it. |
| Forced rule of three | Ideas are repeatedly packaged as three adjectives, nouns, or clauses. | Use the number of items the content requires. |
...
Do not turn a failed search into claims that information is private, scarce, undocumented, or deliberately withheld.

Avoid speculative filler such as:

- “The person appears to maintain a low profile.”
- “The species likely plays an important ecological role.”
- “Specific details are not widely available.”
...
Never invent or complete from memory:

- Sources or URLs
- Authors or article titles
...
2. Confirm that it supports the exact nearby claim.
3. Check names, dates, quotations, numbers, and identifiers.
4. Add page or section locators when needed.
5. Distinguish the source's words from interpretation.
6. Remove tracking parameters that serve no citation purpose.
...
Use sentence case for headings unless the requested style says otherwise.
...
Produce the markup requested by the destination. Do not mix Markdown, HTML, wikitext, or other syntax accidentally.

## Remove response residue

Keep conversation with the user outside the requested artifact.
...
- “I hope this helps.”
- “Would you like a more detailed version?”
...
1. Record the original facts, intent, voice, and required wording.
2. Preserve strong or distinctive sentences.
3. Mark generic, inflated, repetitive, promotional, vague, or unsupported passages.
4. Rebuild weak paragraphs from their underlying point instead of paraphrasing sentence by sentence.
5. Restore simple syntax where ornate language hides the meaning.
6. Compare the revision with the original for lost facts or changed claims.
7. Verify citations, names, quotations, and numbers again.

Do not erase humor, bluntness, uncertainty, regional usage, or idiosyncratic phrasing merely because it is unusual.

Do not make every sentence equally polished. Maintain coherence, but allow the content and the writer's priorities to create natural variation.
...
- The text answers the actual request.
...
- Revision has not changed the intended meaning.
